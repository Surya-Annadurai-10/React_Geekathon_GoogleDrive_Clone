...
import styles from "./PinnedListNotesDisplayCard.module.css"
import { FaAngleDown } from "react-icons/fa6";
import { TiInputChecked } from "react-icons/ti";
import { BsThreeDotsVertical } from "react-icons/bs";
import { MdPushPin } from "react-icons/md";
import { useDispatch } from 'react-redux';
import { addInPinnedArray, deleteListNotesFromNotesArray, unPinListNotes } from '../../slices/userSlice';



const PinnedListNotesDisplayCard = (props) => {
  ...
  <div className={styles.cardContainer}>
    <div className={styles.noteCardHead}>
         ...
         <div className={styles.icons}>
                 ...
                 <MdPushPin onClick={() => handleUnPin(props.id)} className={styles.pin} />
         </div>
         </div>
  <div>
  {
...
export default PinnedListNotesDisplayCard