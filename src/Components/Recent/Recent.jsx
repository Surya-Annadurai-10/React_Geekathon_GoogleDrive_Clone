          ...
          <div className={styles.sharedCon}>
            ...
            <div className={styles.filter_container}>
             ...
             <div className={styles.dataCon}>
                     <img src="https://img.freepik.com/premium-vector/analyzing-data-isolated-cartoon-vector-illustrations_107173-59432.jpg" alt="" />
                     <h2>No recent files</h2>
                     <p>See all the files that ypu've recently edited or opended.</p>
                   </div>
          </div>
        </>
  )
